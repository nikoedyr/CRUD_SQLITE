...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		// System.out.println(
		// "ID Biodata : " + hashMapRecordBiodata.get("id_biodata") +
		// " Nama : " + hashMapRecordBiodata.get("nama") +
		// " Alamat : " + hashMapRecordBiodata.get("alamat"));
		// }
		//
		// }

		// update_biodata(id_biodata, nama, alamat)
		// int status_update = sqLiteHelper.update_biodata(1,
		// "Jhohannes H Purba", "Medan");
		// if (status_update == 1) {
		...
		// tampil_biodata_berdasarkan_id(id_biodata)
		// sqLiteHelper.tampil_biodata_berdasarkan_id(2);
		// System.out.println(sqLiteHelper.tampil_biodata_berdasarkan_id(2)
		// .toString());
